...
ros_mappings = [
    ...
    RosMapping("/c1_drive_controller/odom", mars_message.Odometry, nav_msgs.msg.Odometry, "base_link", mapping_odom, "vodom"),
    RosMapping("/lcmbumper", mars_message.Bumper, sensor_msgs.msg.Range, "base_link", mapping_bumper, "Mbump"),    #暂时用tof替代前档碰撞因坐标无法正常读取,用tof判断方向，用碰撞判断有效性
    ...
    #RosMapping("/ir/left", mars_message.Bumper, sensor_msgs.msg.Range, "base_link", mapping_edge, "Mbump"),
