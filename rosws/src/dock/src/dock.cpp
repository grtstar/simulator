...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber ZeroSpd = n.subscribe("/c1_drive_controller/cmd_vel", 1, SpeedCallback);
    ZeroSpdPub = n.advertise<geometry_msgs::Twist>("/c1_drive_controller/cmd_vel", 1);
