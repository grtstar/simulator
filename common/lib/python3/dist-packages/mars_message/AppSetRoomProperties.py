...
class AppSetRoomProperties(object):
    ...
    __typenames__ = ["int8_t", "int8_t", "int8_t", "int8_t", "int8_t", "int8_t", "int8_t"]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>%db' % self.count, *self.fan[:self.count]))
        buf.write(struct.pack('>%db' % self.count, *self.waterLevel[:self.count]))
    ...
    def _decode_one(buf):
        ...
        self.fan = struct.unpack('>%db' % self.count, buf.read(self.count))
        self.waterLevel = struct.unpack('>%db' % self.count, buf.read(self.count))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x2c349fac2b59703d) & 0xffffffffffffffff
